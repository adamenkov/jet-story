...
namespace Debug
{
	...
	void Render()
	{
		Engine::Print(0, 3, EColor::eC_Black, "\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f"
			"\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f\x1f");

		{
			std::ostringstream os;
			os << "A=" << A << ", B=" << B;
			Engine::Print(0, 3, EColor::eC_White, os.str());
		}
		...
		for (std::shared_ptr<Entity>& pEntity : Maze::GetMaze()->GetRoomEntities())
		{
			...
			if (bDrawPos)
			{
				...
				Engine::DrawText(pos, EColor::eC_White, os.str());
			}
			...
			if (bDrawVel)
			{
				...
				Engine::DrawText(pos + Vector2(0.f, 8.f), EColor::eC_White, os.str());
			}
			...
			if (bDrawAcc)
			{
				...
				Engine::DrawText(pos + Vector2(0.f, 16.f), EColor::eC_White, os.str());
			}
		}
	}
